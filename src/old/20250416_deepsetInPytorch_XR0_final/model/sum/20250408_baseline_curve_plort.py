...
train_df = pd.read_csv('/Users/navin/Library/CloudStorage/Dropbox-AIZOTH/研究/Navin/NEDO/REFPROP_Material property/deepset-bi-mixtures/src/20250416_deepsetInPytorch_XR0_final/preprocessing/train_split.csv')
val_df = pd.read_csv('/Users/navin/Library/CloudStorage/Dropbox-AIZOTH/研究/Navin/NEDO/REFPROP_Material property/deepset-bi-mixtures/src/20250416_deepsetInPytorch_XR0_final/preprocessing/val_split.csv')
test_df = pd.read_csv('/Users/navin/Library/CloudStorage/Dropbox-AIZOTH/研究/Navin/NEDO/REFPROP_Material property/deepset-bi-mixtures/src/20250416_deepsetInPytorch_XR0_final/preprocessing/test_split.csv')
...
# Save to .csv
test_targets = pd.DataFrame(test_targets, columns=target_labels)
test_preds = pd.DataFrame(test_preds, columns=target_labels)
