...
class SMILESDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        target = self.df.loc[idx, ['Tred_0', 'Tred_0_1', 'Tred_0_2', 'Tred_0_3', 'Tred_0_4', 'Tred_0_5', 'Tred_0_6', 'Tred_0_7', 'Tred_0_8', 'Tred_0_9',
 'Tred_1', 'Dred_0', 'Dred_0_1', 'Dred_0_2', 'Dred_0_3', 'Dred_0_4', 'Dred_0_5', 'Dred_0_6', 'Dred_0_7', 'Dred_0_8',
 'Dred_0_9', 'Dred_1']]
...
class DeepSet(nn.Module):
    def __init__(self, embedding_dim=384, output_dim=22):
        super().__init__()
...
df = pd.read_csv('/Users/navin/Library/CloudStorage/Dropbox-AIZOTH/研究/Navin/NEDO/REFPROP_Material property/deepset-bi-mixtures/src/20250331_deepset_curve_KW0/model/sum/split_smiles.csv')
...
for epoch in range(1000): # from 200 to 1000
    total_train_loss = 0
    model.train()
...
target_labels = [
    'Tred_0', 'Tred_0_1', 'Tred_0_2', 'Tred_0_3', 'Tred_0_4', 'Tred_0_5', 'Tred_0_6', 'Tred_0_7', 'Tred_0_8',
    'Tred_0_9',
    'Tred_1', 'Dred_0', 'Dred_0_1', 'Dred_0_2', 'Dred_0_3', 'Dred_0_4', 'Dred_0_5', 'Dred_0_6', 'Dred_0_7', 'Dred_0_8',
    'Dred_0_9', 'Dred_1'
]

# Define the number of rows and columns based on the number of targets
n_targets = len(target_labels)
n_cols = 4  # Number of subplots per row
n_rows = math.ceil(n_targets / n_cols)  # Calculate needed rows dynamically
...
fig.savefig("parity_plots.png", dpi=300)
plt.close(fig)

#plt.show() # Show takes a lot of time
...
n_targets = len(target_labels)
n_cols = 4  # Number of subplots per row
n_rows = math.ceil(n_targets / n_cols)  # Dynamically calculate the number of rows
...
# Save instead of show
fig.savefig("true_vs_predicted_trends.png", dpi=300)
plt.close(fig)
